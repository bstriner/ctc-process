...
from asr_vae.models.ctc_resnet_model import make_ctc_resnet_model_fn


def main(argv):
    asr_vae.trainer.main(argv, make_ctc_resnet_model_fn)


if __name__ == '__main__':
    tf.logging.set_verbosity(tf.logging.INFO)
    tf.flags.DEFINE_string('model_dir', '../output/librispeech/resnet/ctc/v6', 'Model directory')
