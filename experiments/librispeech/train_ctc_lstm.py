...
from asr_vae.models.ctc_model import make_ctc_lstm_model_fn


def main(argv):
    asr_vae.trainer.main(argv, make_ctc_lstm_model_fn)


if __name__ == '__main__':
    tf.logging.set_verbosity(tf.logging.INFO)
    tf.flags.DEFINE_string('model_dir', '../../output/asr_ctc_cudnn/v24-half-l21e-4-depth2-mean-dim512', 'Model directory')
